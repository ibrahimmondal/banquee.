...
export default function Transactions() {
  ...
  <div>
    ...
    <h1 className="max-w-[530px] text-[60px] font-semibold leading-none py-5">Send & receive money instantly</h1>
  ...
  <div>
<Transactionss src={'/image/app.png'} width={300} height={300}/>
  </div>
  </div>
    </section>
  )
